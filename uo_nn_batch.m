...
for num_target = 1:10
    for la = [0.0, 1.0, 10.0]
        for isd = [1,3,7]
            [Xtr,ytr,wo,fo,tr_acc,Xte,yte,te_acc,niter,tex]=uo_nn_solve(num_target, tr_freq,tr_seed,tr_p,te_seed,te_q,la,epsG,kmax,ialmax,kmaxBLS,epsal,c1,c2,isd,isg_ga1,isg_al0,isg_ga2,icg,irc,nu);
